            ...
            <div className="jumbotron container page">
                <div className="row">
                    ...
                    <div className="col-md-8">
                        <h1 style={{textAlign:"left", color:"white"}} className="display-4">About Me</h1>
                        <p className="lead about-text">I began my coding career this year and it has been one of the most vigorous, eye-opening and 
                        thought provoking journeys in my life. I have had the privilege of working alongside many strong programmers in the Rutgers Coding Bootcamp, and cannot wait to continue this coding journey.</p>
